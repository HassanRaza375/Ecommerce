...
const sumbitForm = async () => {
  ...
  try {
    const { data } = await ChangePassword(id.value, obj)
      ...
      <div class="field mb-2">
        <p class="control has-icons-left has-icons-right">
          ...
          <span class="icon is-small is-right is-clickable" @click="showPassword = !showPassword">
            ...
            <i class="icon-svg is-flex" v-else>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
      ...
      <div class="field mb-2">
        <p class="control has-icons-left has-icons-right">
          <input
            ...
            placeholder="Password"
          />
          <span class="icon is-small is-left" @click="showConfirmPassword = !showConfirmPassword">
            <i class="icon-svg is-flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          >
            <i class="icon-svg is-flex" v-if="!showConfirmPassword">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
...
.icon.is-clickable:hover .icon-svg {
  color: hsl(221deg, 14%, 48%);
}
</style>
