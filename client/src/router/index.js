...
import PublicLayout from '../components/layout/DefaultLayout.vue'
  ...
  routes: [
    ...
    // Admin Routes
    {
      ...
      children: [
        ...
        // product management
        { path: 'products', component: () => import('../views/admin/products/allProducts.vue') },
        {
          path: 'products/add',
          component: () => import('../views/admin/products/addNewProduct.vue'),
        },
        { path: 'categories', component: () => import('../views/admin/products/addCategory.vue') },
        {
          path: 'attributes',
          component: () => import('../views/admin/products/addAttributes.vue'),
        },
        {
          path: 'inventory',
          component: () => import('../views/admin/products/manageInventory.vue'),
        },
        // order management
        { path: 'orders', component: () => import('../views/admin/orders/allOrders.vue') },
        {
        ...
        },
        {
          ...
          component: () => import('../views/admin/orders/processingOrder.vue'),
        },
        {
          path: 'orders/pending',
        ...
        },
        {
          ...
          component: () => import('../views/admin/orders/cancelledOrders.vue'),
        },
        // customer management
        { path: 'customers', component: () => import('../views/admin/customers/allCustomers.vue') },
        {
          path: 'customer/:id?',
          component: () => import('../views/admin/customers/customerDetails.vue'),
        },
        {
          path: 'customers/groups',
          component: () => import('../views/admin/customers/customerGroup.vue'),
        },
        // default settings
        {
          path: 'Localization',
    ...
    },
    {
      ...
      name: 'NotFound',
      components: {
        public: () => import('../views/NotFound.vue'),
      },
    },
  ],
})
